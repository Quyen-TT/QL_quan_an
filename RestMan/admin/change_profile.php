...
if (isset($_POST['ChangeProfile'])) {
  ...
  if ($postStmt) {
    $success = "Cập nhật thành công" && header("refresh:1; url=dashboard.php");
  } else {
...
if (isset($_POST['changePassword'])) {
  ...
  if (isset($_POST['old_password']) && !empty($_POST['old_password'])) {
    ...
    $error = 1;
    $err = "Mật khẩu cũ không được trống";
  }
  ...
  if (isset($_POST['confirm_password']) && !empty($_POST['confirm_password'])) {
    ...
    $error = 1;
    $err = "Mật khẩu xác nhận không được trống";
  }
  ...
  if (!$error) {
    ...
    if (mysqli_num_rows($res) > 0) {
      ...
      if ($old_password != $row['admin_password']) {
        ...
        if ($stmt) {
          $success = "Đổi mật khẩu thành công" && header("refresh:1; url=dashboard.php");
        } else {
        ...
        <div class="container-fluid d-flex align-items-center">
          <div class="row">
            <div class="col-lg-7 col-md-10">
              <h1 class="display-2 text-white">Xin chào! <?php echo $admin->admin_name; ?></h1>
                ...
                <form method="post">
                  ...
                  <div class="pl-lg-4">
                    ...
                    <div class=" col-lg-6">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            <input type="submit" id="input-email" name="ChangeProfile" class="btn btn-success form-control-alternative" value="Xác nhận"">
                      </div>
                    </div>
                  </div>
                </div>
