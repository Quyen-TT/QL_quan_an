...
<head>
    ...
    <title>Hệ thống quản lý quán ăn </title>
    <!-- Favicon -->
                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>RestMan</strong>
                                <br>
                                127-0-0-1
                                <br>
                                Ao Sen, Hà Đông, Hà Nội
                                <br>
                                077 777 7777
                            </address>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                            <p>
                                <em>Thời gian: <?php echo date('d/M/Y g:i', strtotime($order->created_at)); ?></em>
                            </p>
                            <p>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center"><?php echo $order->prod_price; ?> VND</td>
                                    <td class="col-md-1 text-center"><?php echo $total; ?> VND</td>
                                </tr>
                                <tr>
                                    <td>   </td>
                                    <td>   </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong><?php echo $total; ?> VND</strong></h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
